cmd_arch/x86_64/boot/setup.o := gcc -Wp,-MD,arch/x86_64/boot/.setup.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/4.8/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -D__ASSEMBLY__   -m64 -DSVGA_MODE=NORMAL_VGA  -D__BIG_KERNEL__   -c -o arch/x86_64/boot/setup.o arch/x86_64/boot/setup.S
